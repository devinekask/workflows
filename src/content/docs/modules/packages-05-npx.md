...
With [npx](https://docs.npmjs.com/cli/v12/commands/npx), you can run commands without installing them. The first time you run it, `npx` will ask to install it, but in fact, it is added to a cache...
